...
def process_goal(s):
    ...
    # There is no minute for this goal
    else:
        remainder = s
        minute = None
...
def process_appearance(s):
    """
    Constructs a very simple list of appearances
    eg
    l = [{'name': 'Pele', 'on': 0, 'off': 70 },]
    """
    # A simpler substitution item that can be plugged into 
    # various places.
